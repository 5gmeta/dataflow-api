...
import authorization # For creating Keycloak authorization for the created topics
...
def create_topic(instance_type, data_type, data_sub_type=None, data_format=None, country=None, quadkey=None, source_id=None, source_type=None, license_type=None, license_geo_limit=None, extra_parameters=None):  # noqa: E501
    ...
    authorization.createKeycloakAuthorization(x_user_id, dest_stream)
...
discovery_url = "http://discovery-api.vicomtech.svc.cluster.local:8080/discovery-api"
